...
export async function getRequestContext() {
	...
	const country = h.get(THOR_COUNTRY_HEADER) ?? c.get(THOR_COUNTRY_COOKIE_NAME)?.value;
	...
	return { store, currency, country, priceChannel: process.env.THOR_PRICE_CHANNEL_ID || undefined };
}
