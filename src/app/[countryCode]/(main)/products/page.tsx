import { ProductsGridQueryVariables, ProductSortKeys, SortDirection } from "@/__generated__/thor/graphql";
...
export default async function AllProductsPage({ params }: PageProps<"/[countryCode]/products">) {
