...
// import { CheckoutMainSkeleton } from "@/features/checkout/checkout-main/checkout-main";
...
// import { CHECKOUT_CART_DETAILS_QUERY, CHECKOUT_PAYMENTGATEWAYS_QUERY } from "@/features/checkout/queries";
...
// export default async function CheckoutPage({ params, searchParams }: PageProps<"/[countryCode]/checkout">) {
...
// 			const gateways = mapEdgesToItems(paymentGatewayResult.data?.paymentGateways);

// 			//for the purpose of this demo, we will assume that there is only one payment gateway and that it is Stripe
// 			const stripeGateway = gateways?.find((gateway) => gateway.__typename === "StripePaymentGateway");
...
// 		else if (cart.paymentSession.paymentGateway.__typename === "StripePaymentGateway") {
...
// 				redirect(`/${country}/checkout?step=${CheckoutStepEnum.Customer}&checkout_id=${checkout_id}`);
// 			}
// 			break;
...
// 				redirect(`/${country}/checkout?step=${CheckoutStepEnum.Delivery}&checkout_id=${checkout_id}`);
// 			}
// 			break;
// 		default:
// 			redirect(`/${country}/checkout?step=${CheckoutStepEnum.Customer}&checkout_id=${checkout_id}`);
...
// 		return <CheckoutPaymentProcessing cart={cart} paymentIntentClientSecret={payment_intent_client_secret} />;
// 	}
...
// 			<Suspense
// 				fallback={
// 					<CheckoutContainer mainArea={<CheckoutMainSkeleton />} summaryArea={<CheckoutSummarySkeleton />} />
// 				}
// 			>
// 				<CheckoutContainer
// 					mainArea={
...
// 						null
// 					}
// 					summaryArea={<CheckoutSummary cart={cart} />}
// 				/>
// 			</Suspense>
