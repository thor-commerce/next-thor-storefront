...
interface Props extends Omit<React.SelectHTMLAttributes<HTMLSelectElement>, "id" | "ref"> {
	label: string;
	id?: string;
	block?: boolean;
...
export default function Select({ label, block, id, ref, options, isInvalid, errorMessage, ...props }: Props) {
