...
import NavbarSignOutButton from "../navbar/components/navbar-profile/navbar-sign-out";
						...
						<form action={formAction} className={s.form}>
							<div className={s.formRow}>
								<TextInput
									...
									block
								/>
								<TextInput label="Last name" name="lastName" defaultValue={customer.lastName ?? ""} block />
							</div>
							<TextInput label="Email" type="email" name="email" defaultValue={customer.email ?? ""} block />
