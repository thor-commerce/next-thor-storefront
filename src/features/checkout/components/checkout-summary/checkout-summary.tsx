							...
							{shippingLine && (
								<div className={s.priceRow}>
									...
									<div className={s.price}>
										<span>
											{shippingLine.total
												? shippingLine.total.centAmount > 0
													? formatMoney({
															money: shippingLine.taxedPrice
																? taxBehavior === TaxBehavior.Exclusive
																	? shippingLine.taxedPrice.net
																	: shippingLine.taxedPrice.gross
																: shippingLine.total,
															minimumFractionDigits: 2,
															maximumFractionDigits: 2,
														})
				...
				<div className={s.details}>
					<div role="row" className={s.item}>
						...
						<div className={s.itemDetails}>
							...
							<SkeletonBox width={60} height={14} style={{ marginTop: "8px" }} />
						</div>
