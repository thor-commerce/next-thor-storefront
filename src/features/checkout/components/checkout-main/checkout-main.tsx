...
// import CheckoutShippingMethods, {
// 	CheckoutShippingMethodsSkeleton,
// } from "./checkout-shipping-methods/checkout-shipping-methods";
...
// 	shippingMethodId: z.string("A shipping method is required").min(1, "Please select a shipping method"),
// });

// export type CheckoutMainFormValues = z.infer<typeof checkoutMainFormSchema>;

// export default function CheckoutMain({ queryRef }: { queryRef: QueryRef<CheckoutCartDetailsQuery> }) {
// 	const {
// 		data: { cart },
...
// 			shippingMethodId: cart.shippingLines.find(Boolean)?.shippingMethod.id || undefined,
// 		},
// 	});
